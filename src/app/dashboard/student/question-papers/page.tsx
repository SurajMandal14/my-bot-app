...
export default function StudentQuestionPapersPage() {
    ...
    const fetchPapers = useCallback(async () => {
        ...
        setIsLoading(true);
        const result = await getQuestionPapersForStudent(authUser.classId, authUser.schoolId.toString());
                        ...
                        <TableRow key={p._id}>
                            ...
                            <TableCell className="text-right">
                                <Button 
                                    variant="outline" 
                                    size="sm" 
                                    onClick={() => handleDownload(p.pdfUrl, `${p.subjectName}_${p.examName}_${p.year}.pdf`)}
                                >
