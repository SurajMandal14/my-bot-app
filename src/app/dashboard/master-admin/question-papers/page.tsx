...
export default function MasterAdminQuestionPapersPage() {
  ...
  useEffect(() => {
    ...
    if (storedUser && storedUser !== "undefined") {
      try {
        ...
        if (parsedUser && parsedUser.role === 'masteradmin' && parsedUser.schoolId) {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-headline flex items-center">
            <FileQuestion className="mr-2 h-6 w-6" /> Question Papers Management
          </CardTitle>
          <CardDescription>
            Upload and manage previous years' question papers for your assigned school.
          </CardDescription>
        </CardHeader>
      </Card>
